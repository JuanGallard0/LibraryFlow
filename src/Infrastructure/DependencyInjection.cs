...
public static class DependencyInjection
{
    ...
    {
        var connectionString = builder.Configuration.GetConnectionString("LibraryFlowDb");
        Guard.Against.Null(connectionString, message: "Connection string 'LibraryFlowDb' not found.");
